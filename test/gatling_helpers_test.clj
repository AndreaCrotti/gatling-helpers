...
(deftest transform-test
  (is (= sample-report (sut/parse-report (slurp "test-resources/stats.js")))))

(def sample-thresholds
  {sut/global-information
   {:meanNumberOfRequestsPerSecond 1000}})

(deftest thresholds-test
  (sut/check-thresholds sample-report sample-thresholds))
